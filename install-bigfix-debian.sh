...
then
    ...
    # Install BigFix
    wget https://software.bigfix.com/download/bes/110/BESAgent-11.0.4.60-debian10.amd64.deb
    wget https://support.bigfix.com/bes/release/11.0/patch4/SHA256SUMS -O - | grep BESAgent-11.0.4.60-debian10.amd64.deb > SHA256
    wget https://support.bigfix.com/bes/release/11.0/patch4/SHA1SUMS -O - | grep BESAgent-11.0.4.60-debian10.amd64.deb > SHA1
    sha256sum -c SHA256 && sha1sum -c SHA1 && {
    ...
    dpkg -i BESAgent-11.0.4.60-debian10.amd64.deb
